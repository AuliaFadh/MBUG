                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    <div class="container1 custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <div style="display: block;" class=" col-lg-8 col-md-12 col-sm-12">
                                            <input type="text"
                                                class="form-control custom-textfield <?= $validation->hasError('nama_form') ? ' is-invalid is-test' : '' ?>"
                                                autofocus id="nama_form" name="nama_form"
                                                value="<?= old('nama_form', isset($input['nama_form']) ? $input['nama_form'] : '') ?>">
                                    ...
                                    <div class="container1 custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <div style="display: block;" class=" col-lg-8 col-md-12 col-sm-12">
                                            <input type="link"
                                                class="form-control custom-textfield <?= $validation->hasError('tautan') ? ' is-invalid is-test' : '' ?>"
                                                id="tautan" name="tautan"
                                                value="<?= old('tautan', isset($input['tautan']) ? $input['tautan'] : '') ?>">
                                            <div class=" invalid-feedback">
                                    ...
                                    <div class="container1 custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <div style="display: block;" class=" col-lg-8 col-md-12 col-sm-12">
                                            <input name="datepicker"
                                                class="custom-textfield datepicker-default form-control col-lg-4 col-md-5 col-sm-7"
                                                id="datepicker">
                                            <div class=" invalid-feedback">
