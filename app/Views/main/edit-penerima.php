        ...
        <div class="col-sm-6 p-md-0  mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/home">
                        ...
                        Dashboard</a></li>
                <li class="breadcrumb-item active"><a href="/penerima">Daftar Penerima Beasiswa</a></li>
                <li class="breadcrumb-item active"><a href="/penerima/edit">Edit Penerima</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <form action="/penerima/save" method="post"> -->
                            <div class="row">
