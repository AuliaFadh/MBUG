...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Filter status
        // Variabel untuk menyimpan status yang dipilih

        // Menambahkan event listener untuk tombol filter status
        
        // Existing event listeners untuk input lainnya (IPK, Semester, TA, dll)
