        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <a href="/admin/akademik/confirm" class="btn btn-primary">Halaman Konfirmasi</a>
            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-md-6 col-12 mb-3">
                    ...
                    <div class="row border-bottom d-flex justify-content-center align-items-center ">
                        <input type="text" id="low-ajaran" placeholder="PTA 1982/1983" class="col-md-4 col-4 mb-3 p-1">
                        <h6 class=" col-1 mb-1  d-flex justify-content-center align-items-center">~
                        </h6>
                        <input type="text" min="1946" id="high-ajaran" placeholder="ATA 2023/2024" class="col-md-4 col-4 mb-3 p-1">
