                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    ...
                                    <div class="container1 custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <div style="display: block;" class=" col-lg-12 col-md-12 col-sm-12">
                                            <input type="text" class="form-control custom-textfield <?= ($validation->hasError('username')) ? ' is-invalid is-test' : ''; ?>" id="username" name="username" autofocus value="<?= old('username', isset($input['username']) ? $input['username'] : ''); ?>">
                                    ...
                                    <div class="container1 custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <div style="display: block;" class=" col-lg-12 col-md-12 col-sm-12">
                                            <input type="password" class="form-control custom-textfield <?= ($validation->hasError('password')) ? ' is-invalid is-test' : ''; ?>" id="password" name="password" value="<?= old('password', isset($input['password']) ? $input['password'] : ''); ?>">
                                            <div class=" invalid-feedback">
