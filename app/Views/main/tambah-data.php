                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                ...
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 ">
                                    ...
                                    <input type="text" class="form-control custom-textfield " id="nama"
                                        name="nama" autofocus value="<?= old('nama') ?>">
                                </div>

                                <div class="form-group col-lg-12 col-md-12 col-sm-12 ">
                                    <label for="asal" class="label-form">Asal Beasiswa</label>
                                    <input type="text" class="form-control custom-textfield " id="asal"
                                        name="asal" value="<?= old('asal') ?>">
                                </div>

                                <div class="form-group col-lg-12 col-md-12 col-sm-12 ">
                                    <label for="tahun" class="label-form">Tahun Penerimaan</label>
                                    <input type="text" class="form-control custom-textfield " id="tahun"
                                ...
                                <div class="container1 custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                    ...
                                    <input type="radio" class="margin-custom" name="nilai" value="0" checked>
                                    Tidak Aktif<br>
                                </div>
