...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p>Website Monitoring Beasiswa merupakan website yang digunakan untuk penggunaan pemantauan administrasi
                    untuk
                    para penerima beasiswa di Universistas Gunadarma. saat ini anda berada pada halaman Penerima
                    Beasiswa.
                </p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                $time = date('Y-m-d');
                ?>
                <?php if ($time < $value["tanggal_tarik"]) : ?>
