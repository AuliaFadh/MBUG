                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                    ...
                                    <div class="container1 row custom-container-form col-lg-12 col-md-12 col-sm-12 ">
                                        ...
                                        <div style="display: block;" class=" col-lg-2 col-md-3 col-sm-5 ">
                                            <input type="number" min=1 max=14
                                                ...
                                                id="semester" required name="semester"
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group row fallback w-100 ">
                                            ...
                                            <input required style=" margin-left :15px" name="krs" type="file"
                                                class="dropify <?= $validation->hasError('krs') ? ' is-invalid is-test' : '' ?>"
                                                data-default-file="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group row fallback w-100">
                                            ...
                                            <input required style=" margin-left :15px" name="blanko_pembayaran"
                                                type="file"
                                                class="dropify <?= $validation->hasError('blanko_pembayaran') ? ' is-invalid is-test' : '' ?>"
                                                data-default-file="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group row fallback w-100">
                                            ...
                                            <input required style=" margin-left :15px" name="bukti_pembayaran"
                                                type="file"
                                                class="dropify<?= $validation->hasError('bukti_pembayaran') ? ' is-invalid is-test' : '' ?>"
                                                data-default-file="">
                                        </div>
                                    </div>
