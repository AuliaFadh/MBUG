...
class lpModel extends Model
{
    ...
    protected $allowedFields    = ['id_beasiswa','uuid_lp', 'id_penerima', 'tingkat', 'jenis_prestasi', 'nama_kegiatan', 'capaian', 'tempat', 'tanggal_mulai', 'tanggal_selesai', 'penyelenggara', 'bukti_prestasi', 'publikasi','konf_ket_prestasi','konfirmasi_prestasi'];
